...
def train_loop_main(config, model, modelV, noise_scheduler, optimizer, train_dataloader, lr_scheduler):
    device = "cuda" if torch.cuda.is_available() else "cpu"
...
train_loop_main(config, model, modelV, noise_scheduler, optimizer, train_dataloader, lr_scheduler)
